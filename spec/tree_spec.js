  ...
  describe("constructor", () => {
    describe("when growing a single-element tree", () => {
      it("generates a tree with no children", () => {
        var tree = new Tree({origin: [0,0], length: 1, angle: 0.0, propagate: 0, vary_by: 0})
      ...
      describe("when growing a tree straight up", () => {
        ...
        it("generates a terminus straight above the origin", () => {
          ...
          var tree = new Tree({origin: [0,0], length: 1, angle: angle, propagate: 0, vary_by: 0})
    ...
    describe("with a single level of children", () => {
      ...
      it("creates two child elements", () => {
        var tree = new Tree({origin: [0,0], length: 1, angle: 0.0, propagate: 1, vary_by: 0})
      ...
      describe("when the vary_by angle is 0", () => {
      ...
      describe("when the vary_by angle is 90 degrees", () => {
        it("the child elements extend away from the parent at 90 degree angles", () => {
          // 1° × π/180 = radians
          // 90deg & pi/180
          var tree = new Tree({origin: [0,0], length: 1, angle: 0.0, propagate: 1, vary_by: (90 * (Math.PI / 180)) })
